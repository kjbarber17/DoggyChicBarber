...
public class editAppointmentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act == null) {
			...
			System.out.println("Pet Id" + tempId + " " +  request.getParameter("id"));
			...
			customerToUpdate.setStreetAddress(streetAddress);
			customerToUpdate.setCity(city);
			customerToUpdate.setState(state);
			customerToUpdate.setZipcode(zip);
			...
			request.setAttribute("services", custService);
			...
			request.setAttribute("services", petService);
			...
			getServletContext().getRequestDispatcher("/cancelNotification.html").forward(request, response);
