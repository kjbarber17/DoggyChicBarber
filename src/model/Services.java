...
public class Services {
	...
	@Transient 
	private final String BASIC_DESC = "Wash, dry, and nail trim";
	@Transient
	private final String PREMIUM_DESC = "Wash, dry, nail trim, haircut";
	@Transient
	private final String SUPER_DESC = "Wash, dry, nail trim, haircut, and furminator";
	@Transient
	...
	public String toString() {
		return "Services [id=" + id + ", planName=" + planName + ", cost=" + cost + ", description=" + description
				+ "]";
	}
